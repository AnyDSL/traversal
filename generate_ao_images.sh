...
./src/frontend -a ../benchmarks/bvhs/conference.bvh -r ../benchmarks/distribs/conference.rays -n 1 -d 0 -ao ao-conference.fbuf -aotmax 280.f -aotmin 0.01 -aos ${nbr_of_samples}
